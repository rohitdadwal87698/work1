...
info_frame = Frame(root, width=506, height=705, bd=2, relief=RIDGE,bg='yellow')
...
heading.place(x=0)
name_label = Label(info_frame, text = "NAME", width=6, font=("Open Sans", 12, 'bold'), bg="yellow")
name_label.place(x=0, y=60)
roll_label = Label(info_frame, text="ROLL NO", width=8, font=("Open Sans", 12, 'bold'),bg='yellow')
roll_label.place(x=0, y=120)
branch_label = Label(info_frame, text="BRANCH", width=8, font=("Open Sans", 12, 'bold'),bg='yellow')
branch_label.place(x=0, y=180)
email_label = Label(info_frame, text="EMAIL", width=6, font=("Open Sans", 12, 'bold'),bg='yellow')
email_label.place(x=0, y=300)
gender_label = Label(info_frame, text="GENDER", width=8, font=("Open Sans", 12, 'bold'),bg='yellow')
gender_label.place(x=0, y=240)
contact_no_label = Label(info_frame, text="CONTACT", width=9, font=("Open Sans", 12, 'bold'),bg='yellow')
contact_no_label.place(x=0, y=360)
d_o_b_label = Label(info_frame, text="D.O.B", width=6, font=("Open Sans", 12, 'bold'),bg='yellow')
...
disp_canvas = Canvas(root ,  width=840, height=700,relief=RIDGE,bg='yellow')
